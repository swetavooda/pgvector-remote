                                     ...
                                     IndexBulkDeleteCallback callback, void *callback_state)
{
    ...
    // yikes! remote makes you read your ids sequentially in pages of 100, so vacuuming a large index is going to be impossible
    ...
    // cJSON* json_vectors = remote_list_vectors(remote_api_key, ReadMetaPage(info->index).host, 100, NULL);
    ...
    // cJSON_ArrayForEach(json_vector, json_vectors) {
        ...
        // ItemPointerData heap_tid = remote_id_get_heap_tid(id);
    ...
    // remote_delete_vectors(remote_api_key, host, ids_to_delete);
    // return NULL;
}
